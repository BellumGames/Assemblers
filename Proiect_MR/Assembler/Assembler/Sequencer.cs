...
namespace Assembler
{
    class Sequencer
    {
        ...
        private void decodeALU(UInt64 MIRCode)
        {
            ...
            switch (alu)
            {
                ...
                case 0xB: //RRC
                    ...
                    break;
                case 0xC: //notDBUS
                    graphicChanger.setALUOperation("notDBUS");
                    graphicChanger.colorAlu();
        ...
        private UInt16 getCl1()
        {
            ...
            UInt16 result = (UInt16)(IR15 & IR13);
            return result; // IR15 & IR13
        }

        private UInt16 getCl0()
        {
            UInt16 IR15 = (UInt16)((regs.IR & 0x8000) >> 15);
            UInt16 notIR14 = (UInt16)(((~regs.IR) & 0x4000) >> 14);
            UInt16 result = (UInt16)(IR15 & notIR14);
            return result; //IR15 & notIR14
        }
